...
# VS Code Extension Release Script
...
echo -e "${BLUE}╔════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║   VS Code Extension Release Script    ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════╝${NC}"
echo ""
...
echo -e "${GREEN}✓ VSIX file created: vscode-ason-${NEW_VERSION}.vsix${NC}"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
  ...
  echo -e "VSIX: ${BLUE}vscode-ason-${NEW_VERSION}.vsix${NC}"
  echo ""
